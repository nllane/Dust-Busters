 #!/usr/bin/pyton3
'''
This code is a hybrid of the other two un tested.
It uses the value of the 90 degree for the distance and also sends the angle of the closest point.
This code should be compadable with all arduino but is untested.
...
## adjust angle sent based on shortest distance
                wall=distance
                position=angle
    count +=1
